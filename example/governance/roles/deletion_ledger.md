...
the version changelog (`paper/_template_changelog.md`), or in the review
where the version is the first and has no changelog.
...
changelog's ledger sections (a first version's, in its review); where more than one section was rebuilt in
