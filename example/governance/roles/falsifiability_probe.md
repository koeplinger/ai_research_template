...
mutation set (shift-year (every entry's year moved forward by one), drop-month (one month's entries removed), duplicate-entry (one entry repeated), alter-figure (a stated figure changed by one); `CHECK_METHODOLOGY.md`, *Slots*).
