...
| the harness wirings, [harness/](harness/) | `MANIFESTO.md` §16, and the reply hook its Slots table names | after each reply; at session start | the tools run at those moments | which harness: the researcher's |
