...
| File | Covers |
|---|---|
| [sources.md](sources.md) | the two synthetic sources shipped with the example |
...
the project fixes in `row (of the roll), page (of the note), section` (`ONTOLOGY.md`, Slots), for
...
fields are `Authors, Title, Where, Year, Identifier, Keywords, Standing`, filled once in `ONTOLOGY.md` (Slots);
