...
- The index is the one place to see every plan with its status; the
  ...
  (`DOCUMENT_GENRES.md`, *What the checker verifies*, item 6), and it is
  the indexing file of this folder (item 8): every plan appears there,
  and this README and the template appear in its *Not plans* table.
